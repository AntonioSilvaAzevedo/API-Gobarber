...
import FakeUserTonkenRepository from '../repositories/fakes/FakeUserTokensRepositrory';
import FakeHashProvider from '../providers/HashProvider/fakes/FakeHashProvider';
import FakeUserTokenRepository from '../repositories/fakes/FakeUserTokensRepositrory';
...
describe('ResetPasswordService', () => {
  beforeEach(() =>{
     ...
     fakeUserTokensRepository = new FakeUserTonkenRepository();
